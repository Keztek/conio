...
function updatePageStyle(mode) {
    ...
    switch (mode) {
        case "dark":
            document.getElementById("themeStylesheet").href = "css/darkmode.css";
            nextMode = "light";
            modeIcon = '<i class="fa-solid fa-moon"></i>';
            break;
        case "light":
            document.getElementById("themeStylesheet").href = "css/lightmode.css";
            nextMode = "system";
            modeIcon = '<i class="fa-solid fa-sun"></i>';
            break;
        case "system":
            document.getElementById("themeStylesheet").href = "css/systemmode.css";
            nextMode = "dark";
